...
public class Game {
	...
	private void bees() { // Main function to run program
		...
		swatImage = swatImage.getScaledInstance((width / 15), (height / 10), Image.SCALE_DEFAULT); // Smart scaling for
																									// swat image
		...
		beeImage = beeImage.getScaledInstance(width / 10, height / 10, Image.SCALE_DEFAULT); // Smart scaling for Bee
																								// image
		...
		beeFlippedImage = beeFlippedImage.getScaledInstance(width / 10, height / 10, Image.SCALE_DEFAULT); // Smart
																											// scaling
																											// for
																											// Flipped
																											// Bee image
